package com.abhinavsanghi.vijayasangeetstudent;
    ...
    public void update(){
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String mname=updatename.getText().toString().trim();
                ...
                if (mname.isEmpty()){
                    ...
                    batchdetails.child(branchs).child(sid).child("sname").setValue(mname).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
